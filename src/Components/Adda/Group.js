									...
									<div class="widget-body">
										<div class="about-author">
											<p>
												...
												that it is possible one day if i
												stay with my dream all time
											</p>
							...
							<div class="card">
								...
								<div class="post-content">
									<p class="post-desc pb-0">
										...
										page editors now use Lorem Ipsum as
										their default model text, and a search
										for Many desktop publishing packages and
										web page editors now use Lorem Ipsum as
										their default model text, and a search
										for Many desktop publishing duskam azer.
									</p>
									<div class="post-meta">
										<button class="post-meta-like">
											<i class="bi bi-heart-beat"></i>
											<span>
												You and 250 people like this
											</span>
											<strong>250</strong>
										</button>
										<ul class="comment-share-meta">
